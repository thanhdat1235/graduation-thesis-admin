...
(<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>)(
  ...
  function sb(a) {
    ...
    })(a.oLanguage.sProcessing).insertBefore(a.nTable)[0];
  }
  function D(a, b) {
  ...
  function Hb(a, b) {
    ...
    if (0 > c) return null;
    var d = a.aoData[c];
    return !d.nTr ? h("<td/>")(B(a, c, b, "display"))[0] : d.anCells[b];
  }
  function Ib(a, b) {
  ...
  function Fa(a) {
    h.each(
      ...
      function (b, c) {
        ...
        b.match(/^html\-/) && (v.type.search[b + a] = v.type.search);
      }
    );
  }
  function Nb(a) {
      ...
      var d = c[0],
        ...
        f = function (a, b) {
          if (Array.isArray(a) || a instanceof h)
            ...
            h("td", c).addClass(b)(a)[0].colSpan = W(d);
            e.push(c[0]);
          }
        };
      f(a, b);
