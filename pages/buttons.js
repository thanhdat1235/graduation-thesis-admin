                    ...
                    <div className="card shadow mb-4">
                      ...
                      <div className="card-body">
                        <p>
                          ...
                          <code>.btn-icon-split</code> className and the markup
                          in the examples below. The examples below also use the
                        ...
                        <p>
                          Also works with small and large button classNamees!
                        </p>
                        <a
                          href="#"
